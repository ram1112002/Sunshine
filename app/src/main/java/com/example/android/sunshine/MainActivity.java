...
//      COMPLETED (4) Pass in this again as the ForecastAdapter now requires a Context
        ...
        LoaderManager.LoaderCallbacks callback = MainActivity.this;
...
//      COMPLETED (18) Call the showLoading method
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                onResetData();
                getSupportLoaderManager().restartLoader(ID_FORECAST_LOADER, null,  callback);
                SunshineSyncUtils.initialized(context);
